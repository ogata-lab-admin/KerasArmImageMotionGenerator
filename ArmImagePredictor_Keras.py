...
class ArmImagePredictor_Keras(OpenRTM_aist.DataFlowComponentBase):
    ...
    def onExecute(self, ec_id):
        ...
        if self._cameraIn.isNew():
            ...
            if not (self._camera_jointPos0 == self._initial_jointPos0 and self._camera_jointPos1 == self._initial_jointPos1 and self._camera_jointPos2 == self._initial_jointPos2 and self._camera_jointPos3 == self._initial_jointPos3 and self._camera_jointPos4 == self._initial_jointPos4 and self._camera_jointPos5 == self._initial_jointPos5):
